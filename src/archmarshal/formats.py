...
DURABLE_FORMATS: tuple[FormatSpec, ...] = (
    FormatSpec(
        ...
        (
            ...
            "archmarshal-adoption-plan-v2",
            "archmarshal-adoption-plan-v3",
            "archmarshal-adoption-plan-v4",
        ),
        ("archmarshal-adoption-plan-v4",),
        migration_status="review-plans-are-regenerated-not-migrated",
        boundedness="bounded-by-adoption-plan-limits",
    ),
    FormatSpec(
        "skill_backup_coverage",
        "archmarshal.adoption",
        "embedded_evidence",
        ("archmarshal-skill-backup-coverage-v1",),
        ("archmarshal-skill-backup-coverage-v1",),
        boundedness="bounded-by-skill-package-and-backup-limits",
    ),
    FormatSpec(
        "workspace_ownership",
    ...
    FormatSpec(
        ...
        "archmarshal.skill_index",
        "embedded_policy",
        ("archmarshal-skill-selection-v1",),
        ("archmarshal-skill-selection-v1",),
        boundedness="10000-exact-project-relative-package-paths",
    ),
    FormatSpec(
        "skill_index_lock",
        "archmarshal.skill_index",
