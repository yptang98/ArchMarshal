...
ACTION_BY_RULE = {
    ...
    "project.save_paths_missing": "Add save_paths.project_files to .agent/workspace.yaml.",
    "project.project_file_save_paths_missing": "Declare user-approved save paths for project files.",
    "project.project_file_save_path_invalid": "Replace invalid project file save paths with non-empty relative paths.",
    "project.project_file_save_path_outside_root": "Move project file save paths under the workspace root or document the external destination.",
    "project.project_file_naming_missing": "Declare a time-first project file naming policy.",
    "project.project_file_naming_invalid": "Use the supported time_topic_kind naming policy.",
